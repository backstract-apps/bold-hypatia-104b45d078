...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_8054c1c8958a40f7ab5d5860584628da
    """
    try:
        ...
        auth_package_secret_key = """TjeS-dNhRibKfuYA9-nbOEoAaKX1OVP9dCIzWUDTX0g="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_0e55e9717a854c4596a96fce26542a24
    """
    try:
